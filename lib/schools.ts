...
const mockSchools = {
  "red-mountain-high": {
    ...
    calendar: {
      ...
      holidays: [
        { name: "Labor Day", date: "2025-09-04" },
        { name: "Fall Break", startDate: "2025-10-09", endDate: "2025-10-13" },
        { name: "Veterans Day", date: "2025-11-10" },
        { name: "Thanksgiving Break", startDate: "2025-11-22", endDate: "2025-11-24" },
        { name: "Winter Break", startDate: "2025-12-25", endDate: "2025-01-05" },
        { name: "Martin Luther King Jr. Day", date: "2025-01-15" },
        { name: "Presidents Day", date: "2025-02-19" },
        { name: "Spring Break", startDate: "2025-03-11", endDate: "2025-03-15" },
        { name: "no school", startDate: "2025-03-29" },
        { name: "Spring Holiday", date: "2025-04-19" },
        { name: "Memorial Day", date: "2025-05-27" },
      ],
      specialDays: [
        { name: "First Day of School", date: "2024-08-07" },
        { name: "Last Day of School", date: "2025-05-23" },
        { name: "Parent-Teacher Conferences", date: "2025-10-05" },
        { name: "Parent-Teacher Conferences", date: "2025-02-22" },
      ],
    },
  },
  "central-high": {
